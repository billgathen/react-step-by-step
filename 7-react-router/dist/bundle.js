...
var Dashboard = React.createClass({displayName: "Dashboard",
  render: function() {
    return React.createElement("h1", null, "How dashing!");
  }
});

var Inbox = React.createClass({displayName: "Inbox",
  render: function() {
    return React.createElement("h1", null, "You've got mail!");
  }
});

var Calendar = React.createClass({displayName: "Calendar",
  render: function() {
    return React.createElement("h1", null, "Take a day just for you");
  }
});
...
// to render the view.
//
// In this case, we're replacing the entire body of the
// page with our content, but we could instead have
// picked a single element to replace, allowing us to
// create things like tabbed widgets that integrate into
// an otherwise-static web page.
//
